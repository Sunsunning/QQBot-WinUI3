...
namespace QQBotCodePlugin.view
{
    ...
    public sealed partial class AddBotPage : Page
    {
        ...
        {
            ba.IsChecked = cat.IsChecked = dragon.IsChecked = eat.IsChecked = play.IsChecked = AIChat.IsChecked = Help.IsChecked = KudosMe.IsChecked = NumberBoom.IsChecked = onset.IsChecked = ping.IsChecked = RunWindowsCommand.IsChecked = Sky.IsChecked = voice.IsChecked = wife.IsChecked = true;
        }

        private void OptionsAllCheckBox_Unchecked(object sender, RoutedEventArgs e)
        {
            ba.IsChecked = cat.IsChecked = dragon.IsChecked = eat.IsChecked = play.IsChecked = AIChat.IsChecked = Help.IsChecked = KudosMe.IsChecked = NumberBoom.IsChecked = onset.IsChecked = ping.IsChecked = RunWindowsCommand.IsChecked = Sky.IsChecked = voice.IsChecked = wife.IsChecked = false;
        }
